...
In figure \ref{fig:absprob}, the initial scenario is presented. Both clients, while connected to the network, are unable to communicate since the firewalls at each endpoint only allow incoming traffic from already established connections.
...
Figure \ref{fig:absrelay} presents the
