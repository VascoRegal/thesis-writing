...
\multicolumn{1}{|c|}{\textbf{Security}}      & Robust, but complex               & \begin{tabular}[c]{@{}c@{}}Generally robust,\\ requires proper configuration\end{tabular} & Modern, state of the art cryptography \\ \hline
\multicolumn{1}{|c|}{\textbf{Usability}}     & Requires expertise                & Requires expertise                                                                        & Minimal configuration                 \\ \hline
\multicolumn{1}{|c|}{\textbf{Performance}}   & Strong                            & Generally implies higher latencies                                                        & Overall, outperforms other protocols  \\ \hline
