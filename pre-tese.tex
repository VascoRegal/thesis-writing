...
\subsection{Basic \ac{ros} Application}
...
This solution's overlay networks should provide a protocol capable of overcoming restrictions blocking direct communications from taking place. Such restrictions are generally associated with firewall rules, \ac{nat} mechanisms and/or routing policies. To establish \ac{p2p} communications between nodes under such topologies, the overlay protocol will create a custom communication channel where.
