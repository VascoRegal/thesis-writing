...
There are however, several software products implementing such an orchestrator, which manage WireGuard tunnels' creation and configuration, such as Tailscale, Netbird or Netmaker. These solutions will be explored in further sections.
