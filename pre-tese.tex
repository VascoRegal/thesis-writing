...
\subsection{Headscale Instance Deployment}
\label{sec:devhs}
...
\subsubsection{Configuring Headscale}
...
\subsection{Communication with ROS}
...
\subsection{Headscale Deployment}
...
\subsubsection{Self-Hosting DERP Infrastructure}
...
\subsubsection{Adding server certificates}
...
\subsubsection{Trusting Headscale}
