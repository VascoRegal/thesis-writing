...
\begin{tabular}{c|c|c|}
\cline{2-3}
                                                                                                        & \textbf{\begin{tabular}[c]{@{}c@{}}Source Camera\\  Feed\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Consumed Camera\\ Feed\end{tabular}} \\ \hline
\multicolumn{1}{|c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Average Bandwidth\\ (MBytes / s)\end{tabular}}} & 27.85                                                                & 6.26                                                                    \\ \hline
\multicolumn{1}{|c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Frame Rate\\ (frames / s)\end{tabular}}}        & 30.058                                                                   & 6.515                                                                      \\ \hline
\end{tabular}
\caption{Streaming performance from both source and consumer's end}
\label{tab:cam}
\end{table}
