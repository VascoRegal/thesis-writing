...
This chapter details the development
...
\subsection{Deploying Headscale}

Headscale's deployment requires both the installation of the software and its configuration, namely the configuration yaml and the server certificate. Both these last files are publicly available in the automation repository.

Hence, the \textbf{install\_headscale.sh} downloads Headscale's package,
